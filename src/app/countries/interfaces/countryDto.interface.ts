...
//
//   const countryDto = Convert.toCountryDto(json);
//
...
export class Convert {
    public static toCountryDto(json: string): CountryDto[] {
        return cast(JSON.parse(json), a(r("CountryDto")));
    }

    public static countryDtoToJson(value: CountryDto[]): string {
        return JSON.stringify(uncast(value, a(r("CountryDto"))), null, 2);
    }
}
